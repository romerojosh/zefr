...
struct InputStruct
{
  unsigned int equation, dt_type, ic_type, nDims, nQpts1D, n_steps, order, low_order, smooth_steps, p_smooth_steps, c_smooth_steps, hmg_levels;
  unsigned int report_freq, write_freq, force_freq, res_type, error_freq, test_case, err_field, coarse_mode, nElesX, nElesY, FMG_vcycles;
  ...
  double AdvDiff_D, dt, CFL, CFL_fv, rel_fac;
