...
def tg_int(meshf, solnfs, nparts):
    ...
    for i in range(nparts):
        ...
        for ename, ebasis in [('hex', HexShape), ('tet', TetShape)]:
            sptname = 'spt_' + ename + '_p{}'.format(i)
            ...
            shapedata[i][ename] = (smat, rcpdjac, gradop, wts)
    ...
    for solnf in solnfs:
        ...
        for i in range(nparts):
            ...
            for ename, (smat, rcpdjac, gradop, wts) in shapedata[i].items():
                # Extract the solution
                soln = solnf['soln_' + ename + '_p{}'.format(i)]
...
if __name__ == '__main__':
    ...
    for l in tg_int(meshf, solnfs, nparts):
