R1 = .24;  // Size of inner cube
R2 = 1.;  // Length of outer prism
R3 = 1.;  // Width of outer prism
NN = 16;  // Number of cells in each direction on inner cube
NL = 10;  // Number of cells going outwards
