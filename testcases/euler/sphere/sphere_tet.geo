...
NN = 10;  // Number of points in each direction on each spherical surface
NL = 16;  // Number of layers between surfaces
prog1 = 1.1;  // Geometric progression factor for layer width
